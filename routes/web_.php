...
use App\Http\Controllers\admin\permissions\ProfileController;
use App\Http\Controllers\admin\permissions\RoleController;
use App\Http\Controllers\admin\permissions\UserController;
...
Route::controller(ShopController::class)->group(function() {
    Route::get('/product/{categorySlug?}/{subCategorySlug?}', 'index')->name('front.shop');
    Route::get('/product/{slug}', 'productDetails')->name('front.product');
});

Route::controller(CartController::class)->group(function() {
    Route::get('/cart','cart')->name('front.cart');
    Route::post('/update-cart','updateCart')->name('front.updateCart');
    Route::post('/customize/neon_sign','store')->name('neon.store');
    Route::post('/customize/frame','store_frame')->name('frame.store');
    ...
    //Payment routes
    //Route::post('payment_new', 'createRazorpayOrder')->name('create.razorpay.order');
...
Route::controller(NeonController::class)->group(function() {
    ...
    Route::get('/products/customise-floro-light-sign', 'index_floro')->name('front.floro');
...
//Route::post('/generate-svg', [SvgController::class, 'generateSvg'])->name('generate.svg');
Route::post('/calculate-price', [PriceController::class, 'calculatePrice'])->name('calculate.price');




Route::post('/clear-cart-session', function (Request $request) {
...
Route::group(['prefix' => 'admin'], function(){
    ...
    Route::group(['middleware' => 'admin.auth'], function(){
        ...
        Route::controller(PermissionController::class)->group(function() {
            ...
            Route::get('/permissions/{id}/update', 'update')->name('permissions.update');
            Route::get('/permissions/{id}/delete', 'delete')->name('permissions.delete');
        ...
        Route::controller(RoleController::class)->group(function() { 
            ...
            Route::get('/roles/{id}/delete', 'delete')->name('roles.delete');
        });
        ...
        Route::controller(UserController::class)->group(function() { 
            ...
            Route::get('/users/{id}/update', 'update')->name('users.update');
        ...
        Route::controller(SettingController::class)->group(function() {
            ...
            Route::post('/settings/banners', 'banners')->name('settings.banners');
