                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('uploads/category/'.$category->image) }}" alt="" height="50"  class="me-3 align-self-center rounded"  />
                                    <div class="flex-grow-1 text-truncate"> 
                                        <h6 class="m-0">{{ $category->name }}</h6>
                                        <a class="fs-12 text-primary" href="{{ route('categories.edit', $category->id) }}">{{ $category->id }}</a>                                        
                                    </div>
                                </div>
                            </td>
                            <td>
