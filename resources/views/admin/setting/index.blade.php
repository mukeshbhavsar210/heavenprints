                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">                        
                                            <form action="" method="post" id="bannerForm" name="bannerForm">
                                                <div class="row">
                                    ...
                                    <tbody>
                                        @if ($banners->isNotEmpty())
                                            @foreach ($banners as $value)
                                                <tr>
                                                    <td width="100"><img src="{{ asset('uploads/banner/thumb/'.$value->image) }}" alt="" style="width: 100px;" /></td>
                                                    <td>{{ $value->name }}</td>
                    ...
                    <div class="card-body">
                        <form id="settingForm" name="settingForm" method="POST" >
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <input type="hidden" id="image1_id" name="image1_id" value=" ">
                                        ...
                                        <img style="width: 100%; margin-top:30px;" src="{{ asset('uploads/logo/'.$settings->image) }}" alt="" />
                                    </div>
                                </div>
...
<script>
    ...
    Dropzone.autoDiscover = false;
        const dropzone = $("#image").dropzone({
            ...
            headers: {
                ...
                $("#banner_id").val(response.image_id);
    ...
    $("#settingForm").submit(function(event){
        ...
        // Logo Upload
        const dropzone1 = new Dropzone("#image1", {
            url: "{{ route('temp-images.create') }}",
            maxFiles: 1,
            paramName: 'image',
            addRemoveLinks: true,
            ...
            success: function (file, response) {
                $("#image1_id").val(response.image_id);
                console.log(response);
            }
        });
