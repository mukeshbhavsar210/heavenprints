                ...
                <div class="row">
                    <div class="col-sm-8 col-12">
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#tabs-1" role="tab">Default </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link " data-toggle="tab" href="#tabs-2" role="tab">Customize</a>
                            </li>            
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tabs-3" role="tab">Neon</a>
                            </li>                    
                        </ul>
                    </div>
                    <div class="col-sm-4 col-12">
                        <form action="" method="get" >
                            <div class="d-flex">                              
                                ...
                                <div class="input-group ml-3 input-group" style="width: 250px; float:right;">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tabs-1" role="tabpanel">
                                <table class="table table-hover text-nowrap">
                                    ...
                                    <tbody>
                                        @if ($default_products->isNotEmpty())
                            ...
                            <div class="tab-pane" id="tabs-2" role="tabpanel">
                                <table class="table table-hover text-nowrap">
                                    ...
                                    <tbody>
                                        @if ($customize_products->isNotEmpty())
                                            @foreach($customize_products as $product)
                                            @php
                                                $productImage = $product->product_images->first();
                                            @endphp
                                            <tr>
                            ...
                            <div class="tab-pane" id="tabs-3" role="tabpanel">
                                <table class="table table-hover text-nowrap">
                                    ...
                                    <tbody>
                                        @if ($neon_products->isNotEmpty())
                                            @foreach($neon_products as $product)
                                            @php
                                                $productImage = $product->product_images->first();
                                            @endphp
                                            <tr>
