<a class="model-preview" data-bs-toggle="modal" data-bs-target="#modal_{{ $item->id }}" >
    @if($item->options->image)
        <img src="{{ asset('storage/' . $item->options->image ) }}" alt="Customised Frame" >
    @else
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body" >
                <img src="{{ asset('storage/' . $item->options->image) }}" alt="Customised Frame" style="width: 100%; border-radius:3px;">
            </div>
        </div>
    </div>
</div>