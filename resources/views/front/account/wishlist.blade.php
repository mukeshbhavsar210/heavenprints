    ...
    <div class="container">        
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-12">
                ...
                <h2 class="h5 mb-0 pt-2 pb-4">Wishlist</h2>
                            ...
                            <div class="col-md-3 col-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h5 class="mb-b mt-2">{{ $wishlist->product->name }}</h5>
                                        ...
                                        <button onclick="removeProduct({{ $wishlist->product_id }})" class="btn btn-outline-danger btn-sm" type="button">Remove</button>
