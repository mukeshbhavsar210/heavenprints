...
<footer>
				...
				<div class="col-md-4 col-12">
					...
					<ul>
						...
						<li>
							...
							: <a href="https://wa.me/whatsappphonenumber" target="_blank">{{ $settings->whatsapp }}</a>
						</li>
						<li>
							<?xml version="1.0" encoding="utf-8"?>
				...
				<div class="col-md-4 col-12">
					<ul class="socialAccounts">
						...
						@if($settings->facebook)
							<li><a href="{{ $settings->facebook }}" target="_blank" class=" social_01"><span class="icon"></span></a></li>
						@endif

						@if($settings->instagram)
							<li><a href="{{ $settings->instagram }}" target="_blank" class=" social_02"><span class="icon"></span></a></li>
						@endif
						
						@if($settings->twitter)
							<li><a href="{{ $settings->twitter }}" target="_blank" class=" social_03"><span class="icon"></span></a></li>
						@endif
						
						@if($settings->pinterest)
							<li><a href="{{ $settings->pinterest }}" target="_blank" class=" social_04"><span class="icon"></span></a></li>
						@endif
					</ul>
				</div>
			</div>
	...
	<a class="back-to-top" style="display: block;"><span class="icon"></span></a>
