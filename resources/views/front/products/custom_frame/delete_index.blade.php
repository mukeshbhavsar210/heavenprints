    ...
    <div class="row">                   
        ...
        <div class="col-md-7 no-padd"> 
            <div class="calculation-main">
                <h3>₹<span id="grandTotal">0</span></h3>
                <button onclick="customFrame()" class="btn btn-primary btm-sm">Add to Cart</button>
            </div>
            <div class="frame-generate">

                {{-- <p><strong>Category:</strong> {{ $selection['category_name'] }}</p>
<p><strong>Shape:</strong> {{ $selection['shape'] ?? 'Not Selected' }}</p>
<p><strong>Size:</strong> {{ $selection['size'] ?? 'Not Selected' }}</p>
<p><strong>Custom Size:</strong> {{ $selection['custom_size'] ?? 'Not Provided' }}</p>
<p><strong>Price:</strong> ${{ $selection['price'] ?? 'Not Selected' }}</p> --}}
                                        ...
                                        <div class="wrapBorder {{ session('frame_class', 'default-class') }}">
                                            <div class="border">
                                                ...
                                                <img id="previewImage1"
                                                    src="{{ session('uploaded_image') ? asset('storage/' . session('uploaded_image')) : '' }}" 
